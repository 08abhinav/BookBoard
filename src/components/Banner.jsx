...
const Banner = () => {
  return (
    <motion.div
      ...
      className="min-h-screen bg-gradient-to-br from-gray-900 to-gray-900/30 relative overflow-hidden flex items-center"
    >
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 w-full">
          ...
          <div
            className="md:col-span-1 lg:col-span-2 h-64 sm:h-80 md:h-[600px] lg:h-[700px] relative flex items-center justify-center"
          >
            <motion.div
            ...
            >
              <div className="absolute inset-0 rounded-3xl backdrop-blur-xl overflow-hidden">
                <img src={bookimg} alt="Book Image" className="w-full h-full object-contain p-8" />
              </div>
            </motion.div>
          </div>
        </div>
